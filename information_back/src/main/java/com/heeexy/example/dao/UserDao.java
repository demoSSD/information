...
public interface UserDao {
    ...
    int updateUserInfo(JSONObject val);
    int getUserQuestionCount(JSONObject val);
    int getUserReplyCount(JSONObject val);
    int getUserApproveCount(JSONObject val);
    int isExit(JSONObject val);
    int newAddUser(User user);
    int newAddUserRole(User user);
    int isCorrect(JSONObject val);
    int upDatePassWord(JSONObject val);
}
